...
### Constants Used 
scale = 0.5
card_height, card_width = 50, 20
left = {'top': 56, 'left': 470, 'width': 370, 'height': 654}
right = {'top': 56, 'left': 880, 'width': 370, 'height': 654}
...
def vision_process(queue):
    ...
    sct = mss()
    itr = 1 # For Managing Interupted Runs 1
    spawn = cv2.imread("assets/spawn.png", cv2.IMREAD_COLOR)
    ...
    while True:
        ...
        if spawn_detected:
            ...
            troop_img.save(f"Data_Collecor/screenshots/troop{itr}.png")
